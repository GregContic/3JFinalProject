        ...
        <aside class="sidebar">
            ...
            <nav>
                <ul class="nav-links">
                    ...
                    <li><a href="#"><i class="fa-solid fa-heart"></i> Services </a></li>
                    <li><a href="schedules.php"><i class="fa-solid fa-calendar-days"></i> Schedule</a></li>
                    <li><a href="transactions.php"><i class="fa-solid fa-file-invoice-dollar"></i> Payments & Reports</a></li>
                </ul>
            </nav>
        ...
        <main class="main-content">
            ...
            <!--add list here-->
                ...
                <span class="action-btn">
                    <form action="" method="">
                        <button class="">Edit Service</button>
                    </form>
                    <form action="" method="">
                        <button class="">Delete Service</button>
                    </form>                    
                    <form action="" method="">
                        <button class="">Add New Service</button>
                    </form>
                </span>
            </div>
        </main>
